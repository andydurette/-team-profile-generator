...
if(inputs.length === 0){
  ...
  const prompts = [
    ...
    },
    {
      type:"list",
      name:"title",
      message:"What is empolyoees job title within the company?",
      choices: ["Engineer", "Intern"],
    },
    {
      name: 'email',
      message: "What is the empolyees email?",
    },
    {
      name: 'github',
      message: "What is the empolyees github?",
    ...
    {
      name: 'school',
      message: "What is the empolyees school?",
      when: function( answers ) {
        // Only run if user set a position
